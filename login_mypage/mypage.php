...
if(empty($_SESSION['id'])){
    ...
    //prepared statement(プリペアーステートメント)でSQL分の型を作る（BDとpostデータを照合させる。select文とwhere句を使用。）
        ...
        <div class="box">
            <div class="box_contents">
                ...
                <div class="basic_info">
                    <p>氏名: <?php echo $_SESSION['name']; ?>
                    </p>
                    <p>メール: <?php echo $_SESSION['mail']; ?>
                    </p>
                    <p>パスワード: <?php echo $_SESSION['password']; ?>
                    </p>
                </div>
                <div class="comments">
