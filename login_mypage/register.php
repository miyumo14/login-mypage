...
<body>
        ...
        <form action="register_confirm.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form_contents">
                ...
                <div class="password">
                    ...
                    <input type="text" class="formbox" size="40" name="password" id="confilm" oninput="ConfilmPassword(this)" required>
                </div>
                <div class="picture">
                    <label>プロフィール写真</label><br>
                    <input type="hidden" nme="max_file_size" value="1000000" />
    ...
    <script>
        function ConfirmPassword(confirm) {
            ...
            if (input1 != input2) {
                confirm.setCostomValidity("パスワードが一致しません");
            } else {
                confirm.setCostomValidity("");
            }
        }
